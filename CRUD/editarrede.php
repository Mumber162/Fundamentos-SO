...
if(isset($_POST['rede'])){
    extract($_POST);
    if($consulta = $conexao->query("update tb_redes_sociais set rcs_rede_social = '$rede' where rcs_codigo = $codigo;")) {
    header("Location: lcredes.php"); 
  } else {
		echo "Erro na edição";
	}
}
$consulta5 = $conexao->query("select * from tb_redes_sociais where rcs_codigo = $codigo");
 ...
 <!--≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡ HEAD ≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡-->
  ...
  <body id="body-search-result">
    ...
    <div class="container mt-3" id="area-pesquisa"
      ...
      <form class="form" action="?codigo=<?php echo $resultado5['rcs_codigo'] ?>" method="POST" id="form-search">
        <div class="form-group">

          <!--======----- Área de PESQUISA -----======-->
          <label for="search">Editar rede:</label>
          <input 
          type="text" 
          class="form-control" 
          value="<?php echo $resultado5['rcs_rede_social'] ?>"
          name="rede" 
          required 
          id="pesquisa" 
