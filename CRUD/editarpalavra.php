...
if(isset($_POST['palavra'])){
    extract($_POST);
    if($consulta = $conexao->query("update tb_palavras_chaves set pcs_palavra_chave = '$palavra' where pcs_codigo = $codigo;")){
      header("Location: lcpalavra.php");
	  }else{
		  echo "Erro na edição";
	  }
}
$consulta3 = $conexao->query("select * from tb_palavras_chaves where pcs_codigo = $codigo");
 ...
 <!--≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡ HEAD ≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡-->
  ...
  <body id="body-search-result">
    ...
    <div class="container mt-3" id="area-pesquisa"
      ...
      <form class="form" action="?codigo=<?php echo $resultado3['pcs_codigo'] ?>" method="POST" id="form-search">
        <div class="form-group">

          <!--======----- Área de PESQUISA -----======-->
          <label for="search">Editar palavra:</label>
          <input 
          type="text" 
          class="form-control" 
          value="<?php echo $resultado3['pcs_palavra_chave'] ?>"
          name="palavra" 
          required 
          id="pesquisa" 
