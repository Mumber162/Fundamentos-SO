...
if(isset($_POST['polarizacao'])){
    extract($_POST);
    if($consulta = $conexao->query("update tb_polarizacoes set pol_polarizacao = '$polarizacao' where pol_codigo = $codigo;")) {
        header("Location: lcpolarizacao.php");
	} else {
		echo "Erro na edição";
	}
}
$consulta4 = $conexao->query("select * from tb_polarizacoes where pol_codigo = $codigo");
 ...
 <!--≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡ HEAD ≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡-->
  ...
  <body id="body-search-result">
    ...
    <div class="container mt-3" id="area-pesquisa"
      ...
      <form class="form" action="?codigo=<?php echo $resultado4['pol_codigo'] ?>" method="POST" id="form-search">
        <div class="form-group">

          <!--======----- Área de PESQUISA -----======-->
          <label for="search">Editar polarizacao:</label>
          <input 
          type="text" 
          class="form-control" 
          value="<?php echo $resultado4['pol_polarizacao'] ?>"
          name="polarizacao" 
          required 
          id="pesquisa" 
