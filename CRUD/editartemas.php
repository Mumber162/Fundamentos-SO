...
if(isset($_POST['tema'])){
    extract($_POST);
    if($consulta = $conexao->query("update tb_temas set tem_tema = '$tema' where tem_codigo = $codigo;")) {
      header("Location: lctemas.php");
  } else {
		echo "Erro na edição";
	}
}
$consulta2 = $conexao->query("select * from tb_temas where tem_codigo = $codigo");
 ...
 <!--≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡ HEAD ≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡-->
  ...
  <body id="body-search-result">
    ...
    <div class="container mt-3" id="area-pesquisa"
      ...
      <form class="form" action="?codigo=<?php echo $resultado2['tem_codigo'] ?>" method="POST" id="form-search">
        <div class="form-group">

          <!--======----- Área de PESQUISA -----======-->
          <label for="search">Editar tema:</label>
          <input 
          type="text" 
          class="form-control" 
          value="<?php echo $resultado2['tem_tema'] ?>"
          name="tema" 
          required 
          id="pesquisa" 
